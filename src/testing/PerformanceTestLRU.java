...
public class PerformanceTestLRU extends TestCase{
	...
	public void setUp() {
		try {
            new LogSetup("logs/testing/PerformanceTestLRU.log", Level.ERROR);
            server = new KVServer(50000, 2000, "LRU", "localhost", 50001); 
            server.clearStorage();
	...
	public void testEightyPutsTwentyGets(){
		...
		writePerformanceResult("LRUEightyPutsTwentyGets", duration);
	}
	...
	public void testFiftyPutsFiftyGets(){
		...
		long endTime = System.nanoTime();
		long duration = (endTime - startTime) / 1000000;
		writePerformanceResult("LRUFiftyPutsFiftyGets", duration);
	}
	...
	public void testTwentyPutsEightyGets(){
		...
		long endTime = System.nanoTime();
		long duration = (endTime - startTime) / 1000000;
		writePerformanceResult("LRUTwentyPutsEightyGets", duration);
	}
