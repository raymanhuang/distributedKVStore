...
public class PerformanceTestNoCache extends TestCase{
	...
	public void setUp() {
		try {
            new LogSetup("logs/testing/PerformanceTestNoCache.log", Level.ERROR);
            server = new KVServer(50000, 20, "none", "localhost", 50001); 
            server.clearStorage();
	...
	public void testEightyPutsTwentyGets(){
		...
		writePerformanceResult("NoCacheEightyPutsTwentyGets", duration);
	}
	...
	public void testFiftyPutsFiftyGets(){
		...
		long endTime = System.nanoTime();
		long duration = (endTime - startTime) / 1000000;
		writePerformanceResult("NoCacheFiftyPutsFiftyGets", duration);
	}
	...
	public void testTwentyPutsEightyGets(){
		...
		long endTime = System.nanoTime();
		long duration = (endTime - startTime) / 1000000;
		writePerformanceResult("NoCacheTwentyPutsEightyGets", duration);
	}
