...
public class PerformanceTestLFU extends TestCase{
	...
	public void setUp() {
		try {
            new LogSetup("logs/testing/PerformanceTestLFU.log", Level.ERROR);
            server = new KVServer(50000, 1000, "LFU", "localhost", 50001); 
            server.clearStorage();
	...
	public void testEightyPutsTwentyGets(){
		...
		writePerformanceResult("LFUEightyPutsTwentyGets", duration);
	}
	...
	public void testFiftyPutsFiftyGets(){
		...
		long endTime = System.nanoTime();
		long duration = (endTime - startTime) / 1000000;
		writePerformanceResult("LFUFiftyPutsFiftyGets", duration);
	}
	...
	public void testTwentyPutsEightyGets(){
		...
		long endTime = System.nanoTime();
		long duration = (endTime - startTime) / 1000000;
		writePerformanceResult("LFUTwentyPutsEightyGets", duration);
	}
